...
export default function AboutPage() {
  return (
    <main>
      ...
      <section className="relative overflow-hidden px-6 py-20 md:px-10 md:py-32">
        ...
        <div className="relative mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-20">
          ...
          <div className="flex flex-col justify-center lg:col-span-5">
            ...
            <h1 className="relative mb-8 font-serif text-5xl leading-[0.95] tracking-tight text-ink md:text-6xl lg:text-7xl">
              Trip intel
              <br />
      ...
      {/* ── Origin + 3 values ──────────────────────────────────────────── */}
      <section className="border-y border-ww-border bg-sand px-6 py-24 md:px-10 md:py-32">
      ...
      {/* ── Founder — portrait + bio + pull quote + CTA ────────────────── */}
      <section className="px-6 py-24 md:px-10 md:py-32">
        <div className="mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 md:grid-cols-2 md:gap-20">
          ...
          <div>
            ...
            <h2 className="mb-8 font-serif text-4xl leading-[0.95] text-ink md:text-6xl">
              A guidebook
              <br />
